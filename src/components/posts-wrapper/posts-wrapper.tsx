...
import { Avatar, Button, Card, Dropdown, Image, Input, Menu, Modal, Popconfirm, Skeleton, Tag } from 'antd'
import qs from 'query-string'
import { Link, useSearchParams } from 'react-router-dom'
import { DeleteOutlined, EditOutlined, EnvironmentFilled, EnvironmentOutlined, HeartFilled, HeartOutlined, MessageOutlined, MoreOutlined, QuestionCircleOutlined } from '@ant-design/icons'
      ...
      {isMobile ? posts.map((post : Post) => (
        ...
        />  
            ...
            <Image
              ...
              height={200}
              preview={false}
              onClick={() => setParams({postId: post.id})}
